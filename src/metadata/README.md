 ...
 * [bero.yml](bero.yml)
     * Determines how your purl.obolibrary.org/obo/bero/ redirects will be handled
     ...
     * Paste in the contents of [bero.yml](bero.yml)
 ...
 * [bero.md](bero.md)
     ...
     * Paste in the contents of [bero.md](bero.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
